...
<h3 align="center">Ingeniero en Sistemas Computacionales · Backend Python & DevOps</h3>
...
Construyo **APIs y servicios backend en Python (FastAPI)**, integro **modelos de Machine Learning** en producción y empaco lo que construyo con buenas prácticas de **DevOps / Cloud** (Docker, CI/CD, Render, AWS) para que llegue a producción de forma confiable.
...
> 🚀 **Disponible para oportunidades remotas en LATAM** como **Backend Developer**, **Python Developer** o **DevOps Engineer Jr/SSr**.

### 🇺🇸 About me

Software Engineer focused on **Python backend (FastAPI)**, **Machine Learning integration**, and **DevOps / Cloud** practices. I have shipped real production systems end-to-end — from a real-time air quality monitoring platform with ML predictions and email alerts, to a cross-platform mobile marketplace with real-time chat. Comfortable across the whole lifecycle: design, build, deploy, maintain.

> 🚀 **Open to remote opportunities across LATAM** as Backend / Python / DevOps / Full-Stack Engineer.
